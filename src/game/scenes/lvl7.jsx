...
class MatchingGameScene extends Phaser.Scene {
    constructor() {
        ...
        this.correctAnswers = ['Honey_bee', 'Wasp', 'ANTS', 'Flies', 'Butterfly'  ]; // Define correct answers
        this.correctMatches = new Set(); // Track matched correct answers
    }

    preload() {
        // Load images for the game
        this.load.image('rectangleCard7', 'assets/7.png'); // Updated to 2.png
    ...
    createRectangleCard(width) {
        const card = this.add.image(width / 2, 190, 'rectangleCard7').setOrigin(0.5).setInteractive();
    ...
    addLeftArrow(width, height) {
        ...
        leftArrow.on('pointerdown', () => {
            this.scene.start('lvl6'); // Adjust to your actual previous scene key
        });
    }
}
