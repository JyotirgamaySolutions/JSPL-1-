...
class MatchingGameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('rectangleCard2', 'assets/2.png'); // Updated to 2.png
...
createRectangleCard(width) {
    ...
    card.on('pointerdown', () => {
        this.displayPopup(card.x, card.y, 
            'Even though it was introduced in India as an oilseed crop in 1969, it is one of the most important oilseeds in the present day.'
        );
    });
...
displayPopup(x, y, message, hasCloseButton = false) {
    ...
    addLeftArrow(width, height) {
        ...
        leftArrow.on('pointerdown', () => {
            this.scene.start('lvl1'); // Adjust to your actual previous scene key
        });
    }
}
